...
|**y**|参数意义：垂直边距, 就是距离图片边缘的垂直距离， 这个参数只有当水印位置是左上，中上， 右上，左下，中下，右下才有意义 默认值：10
 ...
 |可选参数|
|**voffset**|参数意义： 中线垂直偏移，当水印位置在左中，中部，右中时，可以指定水印位置根据中线往上或者往下偏移 默认值：0
...
![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4787/15674242962648_zh-CN.png)
...
如果水印操作是：watermark=1&object=cGFuZGEucG5nQDMwUA&t=90&P=30&x=10&y=10 （右下角打水印）原图按宽度是400，需要缩略，再打上述水印的示例：
...
![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4787/15674242962651_zh-CN.jpg)
...
![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4787/15674242962653_zh-CN.jpg)
...
在图片处理服务里会有很多参数需要变成Base64位编码，参考[RFC4648](http://www.ietf.org/rfc/rfc4648.txt?file=rfc4648.txt)。注意这里的URL安全Base64位编码只是用在水印操作某些特定参数\(文字水印的文字内容，文字颜色，文字字体及图片水印的水印object\)里，不要将其用在签名字符串\(Signature\)的内容里。编码的格式是：
...
-   下面URL的含义是example.jpg加上水印文件panda.png （panda.png 经过URL安全base64编码后是：cGFuZGEucG5n）
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4787/15674242962654_zh-CN.jpg)
...
-   对panda.png按宽度是50缩放。 那么水印文件是：panda.png?x-oss-process=image/resize,w\_50 （经过URL安全base64编码后是:cGFuZGEucG5nP3gtb3NzLXByb2Nlc3M9aW1hZ2UvcmVzaXplLHdfNTA=\)
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4787/15674242962655_zh-CN.jpg)
