...
![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4909/15639619573009_zh-CN.jpg)

OSS上传回调流程解释如下：

|数据流|含义|说明|
|:--|:-|:-|
|1|上传文件并携带回调参数。格式请参见[PostObject](../../../../cn.zh-CN/API 参考/关于Object操作/PostObject.md#)。|通过SDK调用API接口（[PutObject](../../../../cn.zh-CN/API 参考/关于Object操作/PutObject.md#)、[CompleteMultipartUpload](../../../../cn.zh-CN/API 参考/关于MultipartUpload的操作/CompleteMultipartUpload.md#)、[PostObject](../../../../cn.zh-CN/API 参考/关于Object操作/PostObject.md#)）完成。|
...
|JS|[JavaScript客户端签名直传](../../../../cn.zh-CN/最佳实践/Web端上传数据至OSS/Web端PostObject直传实践/JavaScript客户端签名直传.md#)|
...
-   实现示例
    ...
    |PHP|[callback-php-demo.zip](https://gosspublic.alicdn.com/callback-php-demo.zip)|Apache环境下部署运行。|
...
-   返回的Body非JSON格式
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4909/156396195738047_zh-CN.png)

    错误原因有以下两种情况。

    -   应用服务器返回给OSS的Body不是JSON格式。如下图所示：

        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4909/156396195738048_zh-CN.png)
    ...
    -   应用服务器返回给OSS的Body中带有bom头。
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4909/156396195738049_zh-CN.png)
...
-   错误的status
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4909/156396195738050_zh-CN.png)
...
-   超时
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/4909/156396195838051_zh-CN.png)
