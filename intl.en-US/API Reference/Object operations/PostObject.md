...
-   Request header
    ...
    **Note:** The message body of a PostObject request is coded in multipart/form-data format. In PostObject operations, parameters are passed as form fields in the request message body, which are different from paramters passed by HTTP request headers in PutObject operations.
