...
|Status|String|Yes| If the value of this parameter is Enabled, OSS executes this rule regularly. If this value of this parameter is Disabled, OSS ignores this rule.
 ...
 |
|StorageClass|String|Required if Transition is configured.|Specifies the storage class that objects that conform to the rule are converted into. **Note:** The storage class of the objects in a bucket of the IA storage class can be converted into Archive but cannot be converted into Standard.
